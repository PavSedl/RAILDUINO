...
const char hwVer[] = "2.0"; // Statická hodnota pro hardware verzi
...
int LSSwitchPins[numOfLSSwitches] = {9, 11, 12, 13}; // Low-Side switch pins
...
int ledPins[numOfLedPins] = {18, 17}; // LED pins
